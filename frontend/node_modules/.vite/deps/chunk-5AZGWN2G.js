...
var BATCH_STATES = ((enumObj) => Object.freeze(enumObj))({
  PENDING: "pending",
  ADDED: "added",
...
var FILE_STATES = ((enumObj) => Object.freeze(enumObj))({
  PENDING: "pending",
  ADDED: "added",
  UPLOADING: "uploading",
  CANCELLED: "cancelled",
...
var abortNonUploadingItem = (item, aborts, finalizeItem2) => {
  logger_exports.debugLog(`abort: aborting ${item.state.valueOf()} item  - `, item);
...
var esm_default2 = getAbortEnhancer_default;
...
var getIsItemReady = (item) => item.state.valueOf() === FILE_STATES.ADDED.valueOf();
...
var createBatchItemsSender = () => {
  const {
    ...
    send: (items, batch, batchOptions) => {
      ...
      const send2 = (0, import_isFunction.default)(batchOptions.send) ? batchOptions.send : esm_default;
...
var counter = 0;
var getComposedEnhancer = (extEnhancer) => composeEnhancers_default(esm_default2(), extEnhancer);
var getEnhancedUploader = (uploader, options, triggerWithUnwrap, setEnhancerTime) => {
  const enhancer = options.enhancer ? getComposedEnhancer(options.enhancer) : esm_default2();
...
var UploadyContext = import_react.default.createContext(null);
...
var logWarning = (condition, msg) => {
  if (!(0, import_isProduction2.default)() && !condition) {
    console.warn(msg);
  }
};
...
var getIsUploadOptionsComponent = (Component) => Component[UPLOAD_OPTIONS_COMP] === true || Component.target?.[UPLOAD_OPTIONS_COMP] === true || Component.render?.[UPLOAD_OPTIONS_COMP] === true;
...
var NoDomUploady = (props) => {
  ...
  return import_react5.default.createElement(UploadyContext_default.Provider, {
    value: api
  }, children);
};
...
var useAbortItem = () => {
  const context = useUploadyContext_default();
  return (0, import_react6.useCallback)((id) => context.abort(id), [context]);
};
var useAbortItem_default = useAbortItem;

// node_modules/@rpldy/shared-ui/lib/esm/hooks/useAbortBatch.js
var import_react7 = __toESM(require_react());
var useAbortBatch = () => {
  const context = useUploadyContext_default();
  return (0, import_react7.useCallback)((id) => context.abortBatch(id), [context]);
};
var useAbortBatch_default = useAbortBatch;

// node_modules/@rpldy/shared-ui/lib/esm/hooks/useAbortAll.js
var import_react8 = __toESM(require_react());
var useAbortAll = () => {
  const context = useUploadyContext_default();
  return (0, import_react8.useCallback)(() => context.abort(), [context]);
};
var useAbortAll_default = useAbortAll;
...
var createRequestUpdateHoc = ({
  ...
  return import_react9.default.createElement(Component, _extends({}, props, updater));
};
...
var withRequestPreSendUpdate_default = withRequestPreSendUpdate;
...
var withBatchStartUpdate_default = withBatchStartUpdate;
...
//# sourceMappingURL=chunk-5AZGWN2G.js.map
